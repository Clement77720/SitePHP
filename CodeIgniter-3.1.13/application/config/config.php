...
|
*/
$config['base_url'] = '/~jannaire/SAE_PHP/CodeIgniter-3.1.13';
...
$config['sess_save_path'] = sys_get_temp_dir(); // Utiliser le répertoire temporaire du système ou spécifiez un autre chemin
